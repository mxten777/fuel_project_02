...
const MobileTopNav = () => {
  ...
  return (
    <nav className="flex items-center justify-between w-full px-4 py-2 bg-navy-dark/95 text-white shadow-md md:hidden sticky top-0 z-50" role="navigation" aria-label="Mobile top navigation">
      <button
        type="button"
