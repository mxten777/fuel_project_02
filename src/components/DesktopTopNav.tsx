...
const DesktopTopNav = ({ onMenuClick }: { onMenuClick: () => void }) => (
    <nav className="hidden md:flex w-full justify-center gap-4 lg:gap-8 xl:gap-12 py-2 sm:py-4 bg-navy-dark text-white shadow z-40 px-2 sm:px-6" role="navigation" aria-label="Main navigation">
