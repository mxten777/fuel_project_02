...
const CTASection = () => (
  <section className="py-8 xs:py-10 sm:py-12 md:py-16 bg-blue-600 dark:bg-navy-dark text-white flex flex-col items-center w-full transition-colors duration-500 animate-fadein-up">
